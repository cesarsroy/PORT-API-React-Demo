...
const ReportDataBox = ({accessToken, reportCatalog} : Props) => {
    ...
    return (
        ...
        Report Data Example
        <p className="fst-italic fw-normal h6 pt-2">Use this to retrieve the actual report data.</p>
        <button className='btn btn-success' onClick={()=>callData()}>Run</button>
